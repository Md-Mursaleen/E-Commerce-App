...
import { accountData, infoData, wishlistData, orderData } from "../data/ProfileScreenData";
            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                <View style={styles.accountContainer}>
                    <View style={styles.textContainer}>
                        ...
                        <Text style={styles.accountText}>Md</Text>
                    </View>
                ...
                <View style={[styles.containerStyle, { borderBottomWidth: 6.5 }]}>
