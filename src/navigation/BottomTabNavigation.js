    ...
    return (
        <BottomTab.Navigator screenOptions={
            ...
            <BottomTab.Screen name="Profile" component={ProfileScreen} options={{
                tabBarIcon: ({ color }) => <MaterialCommunityIcons name="account-outline" size={30} color={color} />
            }} />
            <BottomTab.Screen name="Cart" component={CartScreen} options={{
                tabBarIcon: ({ color }) => <MaterialCommunityIcons name="cart-outline" size={30} color={color} />
            }} />
